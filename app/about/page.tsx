  ...
  return (
    <section className='prose prose-only-dark relative w-full max-w-3xl pt-8 3xl:max-w-4xl'>
      <article>
        ...
        <p>
          我是鼫鼠五技的
          yuc，這裡有技術相關文章（可能也沒什麼技術成份）以及一些和動植物有關、酷酷生物們的新研究進展或回顧之類的閒聊。
        </p>
        <div>
          <h2 className='text-xl font-bold'>為什麼這裡叫做 Terminal 420</h2>
          <p>抵達航廈（Terminal），然後起飛！</p>
          <h2 className='text-xl font-bold'>
            為什麼文章裡面這麼多奇怪的 quotes
          </h2>
          <p>
          ...
          <h2 className='text-xl font-bold'>上面那個綠綠的小傢伙是誰</h2>
          <p>
