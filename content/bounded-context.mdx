...
## 但現實總不會這麼理想，不會每次都可以把大問題拆解成一個一個界限明顯的小問題

> 我以為我們只要夠努力就可以達成完美的 bounded context，但事實是，這從來沒有發生過
...
好的權責分配就像跑得很快的兩人三腳，兩人間的協調性非常好，讓產品開發十分快速且順利；而糟糕的權責分配像是一匹馬，被許多人拉往各個方向，最後停滯不前。就像我們嘗試用一個相同的語言來解釋一個相當複雜的系統，每個人能對於這個語言的認知鬥不同，最後導致沒有人能夠向前移動。而 Bounded Context 讓我們不用每個人都同意每件事，因為每個人的 model 不同，就會被不同的 boundary 所限制住。
