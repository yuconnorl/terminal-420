...
date: 2023-Oct-30 17:43:58+08:00
category: system
---
...
<CustomImage src='/images/newbie-ssh/door-breaking-port-22.jpg' width={600} height={637} alt='Port 22 door breaking'/>

通常預設的 SSH 連線 Port 會是 22，所以機器被掃到就會被瘋狂嘗試登入！

<CustomImage src='/images/newbie-ssh/default-port-attempt-login.png' width={567} height={45} alt='default port' caption='短短幾分鐘內就被踹了四千多次 🤔'/>
